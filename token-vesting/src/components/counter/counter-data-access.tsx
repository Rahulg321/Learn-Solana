...
import { getCounterProgram, getCounterProgramId, getVestingProgram, getVestingProgramId } from '@project/anchor'
...
export function useVestingProgram {
  ...
  const initialize = useMutation({
    ...
    mutationFn: (keypair: Keypair) =>
      program.methods.createVestingAccount('Company Name').accounts({
        signer: keypair.publicKey,
        vestingAccount: keypair.publicKey,
        mint: new PublicKey('mint_address_here'),
        treasuryTokenAccount: new PublicKey('treasury_address_here'),
