...
const metadata = {
  name: "Jubreakit Jubutit Updated",
  description: "Impractical Jokers Sal Specifc NFT",
  image,
...
const asset = await fetchAsset(
  umi,
  UMIPublicKey("6fhE2KikuWXBW1T8VosAaSLbaJP27d6iFToCMfEedqnp")
);
...
await update(umi, {
  asset,
  collection,
  name: "Jubreakit Jubutit Murr Impractical Jokers",
  uri,
}).sendAndConfirm(umi);
